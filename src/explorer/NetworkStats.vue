                                ...
                                <div v-for="(balance, validator) in stakingState.fees.balances" :key="validator" class="bg-secondary/5 rounded-lg p-4">
                                    ...
                                    <div class="w-full bg-white/20 rounded-full h-2 mb-2">
                                        <div 
                                            ...
                                            :style="{ width: `${(balance.balance / Math.max(...Object.values(stakingState.fees.balances).map(b => b.balance)) * 100)}%` }"
                                        ></div>
                                    </div>
                                    <div class="grid grid-cols-2 gap-2 text-sm text-neutral">
                                        ...
                                        <div>
                                            Delegated: <span class="text-secondary">{{ formatNumber(validatorDelegations[validator] || 0) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
